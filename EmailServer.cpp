...
int main(void)
{
	EmailServer myTestServer;
	std::string email = "khbjh179@gmail.com";
	std::string message = "This is a test email from EmailServer";
	myTestServer.sendEmail(email, message);
